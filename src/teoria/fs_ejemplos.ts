...
export function fsAppendFile(path: string, data: string) {
...
export function fsChmod(path: string, mode: string) {
...
export function fsClose(fd: number) {
    fs.close(fd, (err) => {
        if (err) {
...
export function fsCp(path: string, dest: string) {
    fs.cp(path, dest, (err) => {
        if (err) {
...
export function fsFstat(fd: number) {
...
export function fsFsync(fd: number) {
    fs.fsync(fd, (err) => {
        if (err) {
...
export function fsFtruncate(fd: number, len: number) {
...
export function fsFutimes(fd: number, atime: Date, mtime: Date) {
...
export function fsLink(src: string, dest: string) {
...
export function fsLstat(path: string) {
...
export function fsOpen(path: string, flags: string, mode: number) {
...
export function fsOpendir(path: string) {
...
export function fsRead(fd: number, buffer: Buffer, offset: number, length: number, position: number) {
...
export function fsReaddir(path: string) {
...
export function fsRealpath(path: string) {
...
export function fsRmdir(path: string) {
    fs.rmdir(path, (err) => {
        if (err) {
...
export function fsRm(path: string) {
    fs.rm(path, (err) => {
        if (err) {
...
export function fsWatchFile(path: string, options: any, listener: (curr: fs.Stats, prev: fs.Stats) => void) {
    fs.watchFile(path, options, listener);
}
//fs.write(fd, buffer, offset, length, position, callback) //Escribe datos en un archivo
export function fsWrite(fd: number, buffer: Buffer, offset: number, length: number, position: number) {
...
export function fsWriteFile(path: string, data: string) {
...
export function fsAppendFileSync(path: string, data: string) {
    try {
...
export function fsCloseSync(fd: number) {
    try {
        fs.closeSync(fd);
        console.log('Archivo cerrado');
    }
...
export function fsCopyFileSync(src: string, dest: string) {
    try {
...
export function fsCpSync(path: string, dest: string) {
    try {
        fs.cpSync(path, dest);
        console.log('Directorio copiado');
    }
...
export function fsFstatSync(fd: number) {
    try {
...
export function fsFsyncSync(fd: number) {
    try {
        fs.fsyncSync(fd);
        console.log('Archivo sincronizado');
    }
...
export function fsFtruncateSync(fd: number, len: number) {
    try {
...
export function fsFutimesSync(fd: number, atime: Date, mtime: Date) {
    try {
...
export function fsMkdirSync(path: string) {
    try {
        fs.mkdirSync(path);
        console.log('Directorio creado');
    } catch (err) {
...
export function fsOpenSync(path: string, flags: string, mode?: number) {
    try {
...
export function fsOpendirSync(path: string) {
    try {
...
export function fsReadSync(fd: number, buffer: Buffer, offset: number, length: number, position: number) {
    try {
...
export function fsReaddirSync(path: string) {
    try {
...
export function fsReadFileSync(path: string) {
    try {
...
export function fsRealpathSync(path: string) {
    try {
...
export function fsRenameSync(oldPath: string, newPath: string) {
    try {
...
export function fsRmdirSync(path: string) {
    try {
        fs.rmdirSync(path);
        console.log('Directorio eliminado');
    } catch (err) {
...
export function fsRmSync(path: string) {
    try {
        fs.rmSync(path);
        console.log('Archivo o directorio eliminado');
    } catch (err) {
...
export function fsStatSync(path: string) {
    try {
...
export function fsWriteSync(fd: number, buffer: Buffer, offset: number, length: number, position: number) {
    try {
...
export function fsWriteFileSync(path: string, data: string) {
    try {
...
export function fsWatchFileSync(path: string, options: any, listener: (curr: fs.Stats, prev: fs.Stats) => void) {
    try {
        fs.watchFile(path, options, listener);
