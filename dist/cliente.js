...
yargs(hideBin(process.argv)).command('add', 'Adds a funko', {
    ...
    addFunko(args.id, args.user, args.nombre, args.descripcion, args.tipo, args.genero, args.franquicia, args.numero, args.exclusivo, args.caracteristicasEspeciales, args.valorMercado);
}).help().argv;
...
yargs(hideBin(process.argv)).command('modify', 'Modifies a funko', {
    ...
    modificarFunko(args.id, args.user, args.nombre, args.descripcion, args.tipo, args.genero, args.franquicia, args.numero, args.exclusivo, args.caracteristicasEspeciales, args.valorMercado);
}).help().argv;
