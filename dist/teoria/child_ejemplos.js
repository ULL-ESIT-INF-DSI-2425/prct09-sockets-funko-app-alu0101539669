...
export function ChilldProcessExec(command) {
...
export function ChilldProcessExecFile(file, args) {
...
export function ChilldProcessFork(modulePath, args) {
...
export function spawnExample(command, args = []) {
...
export function execFileSyncExample(file, args = []) {
    try {
...
export function execSyncExample(command) {
    try {
...
export function spawnSyncExample(command, args = []) {
    try {
