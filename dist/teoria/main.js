import { fsAccess, fsAppendFile, fsChmod, fsCopyFile, fsMkdir, fsStat, fsRename, fsRm, fsAccessSync, fsAppendFileSync, fsCopyFileSync, fsMkdirSync, fsRenameSync, fsRmSync, fsStatSync, } from './fs_ejemplos.js';
import { ChilldProcessExec, ChilldProcessExecFile, ChilldProcessFork, spawnExample, execFileSyncExample, execSyncExample, spawnSyncExample, } from './child_ejemplos.js';
