 ...
 */
export function leerFunkos(usuario, callback) {
 ...
 */
export function addFunko(id, usuario, nombre, descripcion, tipo, genero, franquicia, numero, exclusivo, caracteristicasEspeciales, valorMercado, callback) {
    const nombre_usuario = usuario;
    const path = "./database/" + nombre_usuario;
    access(path, (err) => {
        if (err) {
 ...
 */
export function eliminarFunko(usuario, ID_, callback) {
    const nombre_usuario = usuario;
    const path = "./database/" + nombre_usuario;
    access(path, (err) => {
        if (err) {
 ...
 */
export function modificarFunko(id, usuario, nombre, descripcion, tipo, genero, franquicia, numero, exclusivo, caracteristicasEspeciales, valorMercado, callback) {
    const nombre_usuario = usuario;
    const path = "./database/" + nombre_usuario;
    access(path, (err) => {
        if (err) {
 ...
 */
export function listaFunkos(usuario, callback) {
    const nombre_usuario = usuario;
    const path = "./database/" + nombre_usuario;
    access(path, (err) => {
        if (err) {
 ...
 */
export function mostrarFunko(usuario, id, callback) {
    const nombre_usuario = usuario;
    const path = "./database/" + nombre_usuario;
    access(path, (err) => {
        if (err) {
